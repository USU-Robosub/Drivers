...
bool BMP085::initialize(uint8_t mode)
{
    ...
    uint8_t devtest = I2C::readByte(BMP085_ADDR, BMP085_DEVICE);
    if (devtest != BMP085_DEV_ID)
        return false;

    /* read calibration data */
    ac1 = I2C::readShort(BMP085_ADDR, BMP085_CAL_AC1);
    ac2 = I2C::readShort(BMP085_ADDR, BMP085_CAL_AC2);
    ac3 = I2C::readShort(BMP085_ADDR, BMP085_CAL_AC3);
    ac4 = I2C::readShort(BMP085_ADDR, BMP085_CAL_AC4);
    ac5 = I2C::readShort(BMP085_ADDR, BMP085_CAL_AC5);
    ac6 = I2C::readShort(BMP085_ADDR, BMP085_CAL_AC6);

    b1  = I2C::readShort(BMP085_ADDR, BMP085_CAL_B1);
    b2  = I2C::readShort(BMP085_ADDR, BMP085_CAL_B2);

    mb  = I2C::readShort(BMP085_ADDR, BMP085_CAL_MB);
    mc  = I2C::readShort(BMP085_ADDR, BMP085_CAL_MC);
    md  = I2C::readShort(BMP085_ADDR, BMP085_CAL_MD);
...
{
    I2C::writeByte(BMP085_ADDR, BMP085_CONTROL, BMP085_TEMPERATURE);
    delay(5);

    return I2C::readShort(BMP085_ADDR, BMP085_RESULT);
}
...
uint32_t BMP085::readRawPressure(void)
{
    ...
    I2C::writeByte(BMP085_ADDR, BMP085_CONTROL, BMP085_PRESSURE0 +
    ...
    raw = I2C::readShort(BMP085_ADDR, BMP085_RESULT);

    raw <<= 8;
    raw |= I2C::readByte(BMP085_ADDR, BMP085_RESULT+2);
    raw >>= (8 - oversampling);
